...
namespace DictionaryCountOccurances
{
    class Program
    {
        static void Main(string[] args)
        {
            int[] ints =
            {
                8,1,2,5,9,6,1,2,9,8,2,4,7,0,1,3,7,9,4,9,6,8,7,1,9,5,8,4,6,1,8,9,6,6,0,2,7,6,0,6,
            ...
            {
                Console.WriteLine($"The digit {key} occurs {d[key]} times");
            }
        }
    }
}
